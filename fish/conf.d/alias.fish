...
alias bc 'calc'
alias tcoll 'tmux attach-session -t coll'
alias tdyeing 'tmux attach-session -t dyeing'
alias tlogs 'tmux attach-session -t logs'
alias tweb 'tmux attach-session -t web'
alias tworkorder 'tmux attach-session -t workorder'
alias tcommon 'tmux attach-session -t common'
